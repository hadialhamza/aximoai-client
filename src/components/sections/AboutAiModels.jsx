        ...
        <div className="bg-white/95 dark:bg-slate-950/90 border border-slate-200 dark:border-slate-800 shadow-[0_1px_15px_rgba(0,0,0,0.15)] p-5 md:p-6 lg:p-8 rounded-2xl">
          ...
          <div className="flex flex-col gap-6 md:gap-8 md:flex-row md:items-start md:justify-between">
            <div className="flex-1 space-y-4">
              ...
              <p className="text-base md:text-lg text-slate-700 dark:text-slate-300 leading-relaxed">
                In <span className="font-semibold text-primary">AximoAI</span>,
              ...
              <div className="mt-4 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-primary/20 bg-primary/5 p-4 shadow-sm hover:shadow-md transition">
            ...
            <div className="flex-1">
              <div className="relative rounded-3xl border border-primary/20 bg-linear-to-br from-primary/5 via-white to-primary/5 dark:from-slate-900 dark:via-slate-950 dark:to-primary/10 p-6 shadow-[0_18px_50px_rgba(var(--color-primary),0.12)]">
                <div className="pointer-events-none absolute -top-10 right-[-30px] h-32 w-32 rounded-full bg-primary/20 blur-3xl" />
                ...
                <div className="mt-5 flex items-center justify-between gap-3 text-xs">
                  ...
                  <div className="rounded-full border border-primary/20 bg-white dark:bg-slate-950 px-3 py-2 text-center">
                ...
                <div className="mt-4 border-t border-primary/20 pt-3 text-[11px] text-slate-600 dark:text-slate-400">
                  This is a{" "}
                  <span className="font-semibold text-slate-900 dark:text-slate-100">
                    static section
                  </span>{" "}
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-6 shadow-sm hover:shadow-md transition">
              ...
              <p className="mt-2 text-sm text-slate-700 dark:text-slate-300">
                ...
                centralizes metadata, improves searchability, and encourages
              ...
              <div className="mt-5">
                <Link to="/models">
                  <MyBtn variant="primary" icon={Rocket}>
                    Browse Models
                  </MyBtn>
                </Link>
              </div>
          ...
          <div className="mt-8 rounded-xl border border-primary/20 bg-primary/5 px-5 py-4 text-sm text-slate-700 dark:text-slate-300">
            <span className="font-semibold text-primary">Tip:</span> If you want
            to learn more about AI models, login to our website and check out
            the pages.
          </div>
        </div>
      </Container>
